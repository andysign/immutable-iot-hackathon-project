...
class App(Frame):
	def __init__(self,master=None):
		...
		t1 = Text(main_frame, width=17, height=1, font=("Courier",14))
		...
		t2 = Text(main_frame, width=13, height=1, font=("Courier",10))
		...
		self.blk_height_lbl = Label(bg="#777",fg="#aff",font=("Courier",11))
		self.blk_height_lbl.place(x=92, y=48)

		t3 = Text(main_frame, width=13, height=1, font=("Courier",10))
		...
		self.blk_time_lbl = Label(bg="#777",fg="#aff",font=("Courier",11))
		self.blk_time_lbl.place(x=92, y=68)

		t4 = Text(main_frame, width=17, height=1, font=("Courier",14))
		...
		t3 = Text(main_frame, width=19, height=1, font=("Courier",10))
		t3.tag_configure("center", justify='left')
